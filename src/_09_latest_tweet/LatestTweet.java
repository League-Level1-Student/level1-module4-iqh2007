...
public class LatestTweet extends JPanel implements ActionListener {
	...
	public LatestTweet() {
		...
		button1 = new JButton("Search the Twitterverse");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (j == button1) {
			System.out.println(getLatestTweet(textfield1.getText()));
		}
	}
}
